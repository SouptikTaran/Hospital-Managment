  ...
  return (
    <>
        <div className="flex items-center md:gap-[10rem]">
            ...
            <div className="flex md:ml-[5rem] ml-[2rem] items-center border md:w-[10%] justify-evenly">
                <div className="p-3 bg-white bg-opacity-60 rounded-full hidden md:flex"><Bell size={20} strokeWidth={1.5} color="#007bff"/></div>
                <div className="p-3 bg-white bg-opacity-60 rounded-full "><User size={20} strokeWidth={1.5} color="#007bff"/></div>
            </div>
        </div>
    </>
  )
