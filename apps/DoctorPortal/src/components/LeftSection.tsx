...
export const LeftSection = () => {
  ...
  return (
    <>
      <div className="md:flex flex-col items-center hidden justify-start gap-4 w-[20%]  bg-[#0a1d3c] border-r-2 pt-4 border-r-slate-300  h-[100vh] text">
        ...
        <div className="flex flex-col gap-5 w-full items-center mt-2">
          <SideItem color="#007bff">
            ...
            <span className="w-[60%] text-white">Dashboard</span>
          </SideItem>
          <SideItem color="#46505f">
            <div className="w-[20%] text-white">
              <Calendar size={20} />
            </div>
            <span className="w-[60%] text-white">Appointments</span>
          </SideItem>
          <SideItem color="#46505f">
            <div className="w-[20%] text-white">
              <FileText size={20} />
          ...
          <SideItem color="#46505f" onClick={handleLogout}>
            ...
            <span className="w-[60%] text-white">Logout</span>
          </SideItem>
        </div>
      </div>
